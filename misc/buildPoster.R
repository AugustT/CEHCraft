...
# Build a poster from overviewer images
library(imager)

images_folder <- 'C:/Users/Tom/OneDrive - Natural Environment Research Council/aRt/Minecraft/overviewer/TEST/world-lighting'

# images_folder <- 'C:/Users/Tom/OneDrive - Natural Environment Research Council/aRt/Minecraft/overviewer/TEST/world-lighting/3/0/1/0/3/2'
...
for(levels in 5:7){
  ...
  jpeg(filename = paste0('misc/posterMap', levels, '.jpeg'),
